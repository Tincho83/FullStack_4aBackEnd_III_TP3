...
const getAdoption = async (req, res, next) => {
    ...
    try {
        ...
        if (!mongoose.Types.ObjectId.isValid(adoptionId)) {
            ...
            CustomError.createError("Adoption ID Error", ERROR_MESSAGES.PET.INVALID_ID, { adoptionId }, ERROR_TYPES.TIPO_DE_DATOS);
        }
        ...
        if (!adoption) {
            ...
            CustomError.createError("Adoption not found.", ERROR_MESSAGES.PET.PET_NOT_FOUND, { adoptionId }, ERROR_TYPES.NOT_FOUND);
        }
...
const createAdoption = async (req, res, next) => {
    ...
    try {
        ...
        if (!mongoose.Types.ObjectId.isValid(uid)) {
            ...
            CustomError.createError("User ID Error", ERROR_MESSAGES.PET.INVALID_ID, { uid }, ERROR_TYPES.TIPO_DE_DATOS);
        }
